...
//
//public class FastenerInsideSleeper implements ConstraintPattern {
//
//    private final int pos_tol; // tolerance on the positions of bboxes
//
//    public FastenerInsideSleeper(int pos_tol) {
...
//        CPIntVar[] pattern = makeIntVarArray(cp, 2, n); // pattern[0] represents the sleeper (outside) and pattern[1] represents the fastener (inside)
//
...
//
//        CPIntVar fastener_x1 = element(x_mins, pattern[1]);
//        CPIntVar fastener_x2 = element(x_maxs, pattern[1]);
//        CPIntVar fastener_y1 = element(y_mins, pattern[1]);
//        CPIntVar fastener_y2 = element(y_maxs, pattern[1]);
//        CPIntVar fastener_cls_id = element(cls_ids, pattern[1]);
//        CPIntVar fastener_box_id = element(box_ids, pattern[1]);
//
...
//
//        search.onSolution(() ->
//                System.out.println("solution:" + "Sleeper has ID" + sleeper_box_id + " and fastener has ID" + fastener_box_id)
//        );
